...
class logn extends CI_Controller 
{
    ...
    public function index() 
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('template/logn_header', $data);
            $this->load->view('logn/login');
            $this->load->view('template/logn_footer');
        } else {
        ...
        if($user) {
            ...
            if($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($role_id == 1) {
                        redirect('admin/index'); // Jika peran adalah admin, arahkan ke halaman admin
                    } elseif ($role_id == 2) {
                        redirect('beranda/index'); // Jika peran adalah pengguna, arahkan ke halaman pengguna
                    } else {
                        // Jika peran tidak valid, arahkan ke halaman login dan hapus data sesi
